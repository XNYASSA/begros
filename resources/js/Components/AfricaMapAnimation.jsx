...
const COUNTRY_BOUNDS = {
  'CM': { name: 'Cameroon', x: 430, y: 340, w: 60, h: 90 },
  'CG': { name: 'Congo', x: 500, y: 450, w: 50, h: 60 },
  'CD': { name: 'Dem. Rep. Congo', x: 570, y: 420, w: 70, h: 120 },
  'CF': { name: 'Central African Rep.', x: 550, y: 370, w: 70, h: 80 },
  'GA': { name: 'Gabon', x: 470, y: 460, w: 40, h: 50 },
  'GQ': { name: 'Eq. Guinea', x: 420, y: 475, w: 30, h: 30 },
  'NG': { name: 'Nigeria', x: 360, y: 320, w: 70, h: 60 },
  'CI': { name: 'Côte d\'Ivoire', x: 220, y: 350, w: 50, h: 50 },
  'GH': { name: 'Ghana', x: 300, y: 350, w: 40, h: 50 },
  'BJ': { name: 'Benin', x: 330, y: 340, w: 25, h: 50 },
  'TG': { name: 'Togo', x: 300, y: 350, w: 20, h: 45 },
  'SN': { name: 'Senegal', x: 230, y: 300, w: 30, h: 40 },
  'ML': { name: 'Mali', x: 280, y: 250, w: 60, h: 70 },
  'BF': { name: 'Burkina Faso', x: 280, y: 290, w: 50, h: 50 },
  'NE': { name: 'Niger', x: 420, y: 200, w: 80, h: 120 },
  'TD': { name: 'Chad', x: 520, y: 250, w: 90, h: 120 },
  'ET': { name: 'Ethiopia', x: 710, y: 310, w: 70, h: 100 },
  'KE': { name: 'Kenya', x: 680, y: 450, w: 60, h: 80 },
  'UG': { name: 'Uganda', x: 660, y: 430, w: 40, h: 60 },
  'TZ': { name: 'Tanzania', x: 650, y: 500, w: 60, h: 80 },
  'MZ': { name: 'Mozambique', x: 680, y: 570, w: 50, h: 70 },
  'ZM': { name: 'Zambia', x: 600, y: 560, w: 60, h: 70 },
  'ZW': { name: 'Zimbabwe', x: 630, y: 620, w: 50, h: 50 },
  'AO': { name: 'Angola', x: 490, y: 590, w: 60, h: 100 },
  'ZA': { name: 'South Africa', x: 580, y: 700, w: 60, h: 80 },
};
...
export function AfricaMapAnimation() {
  ...
  const [planes, setPlanes] = useState([
    { id: 1, x: 200, y: 200, vx: 0.08, vy: 0.06, color: '#4DB8E8' },
  ]);
  const [highlightedCountry, setHighlightedCountry] = useState(null);
  const [highlightedCountries, setHighlightedCountries] = useState({});

  // Load SVG and store original colors
  useEffect(() => {
      ...
      setPlanes((prevPlanes) => {
        const newPlanes = prevPlanes.map((plane) => {
          ...
          if (frameCount % 2 === 0) {
            ...
            if (firstCountry) {
              setHighlightedCountry(COUNTRY_BOUNDS[firstCountry]?.name);
            } else {
